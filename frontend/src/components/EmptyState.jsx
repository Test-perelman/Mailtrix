...
import { Inbox, Zap, ArrowRight, Database, Radio } from 'lucide-react';
import styles from './EmptyState.module.css';

export default function EmptyState({ onLoadDemo }) {
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        {/* Text content */}
        <h2 className={styles.title}>Waiting for <span className={styles.titleAccent}>job matches</span></h2>
        ...
        <div className={styles.statusPill}>
          ...
          <Radio size={14} className={styles.statusIcon} />
        </div>
